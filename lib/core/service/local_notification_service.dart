...
class LocalNotificationService {
  ...
  //showDailySchduledNotification
   Future<void> showDailySchduledNotification({
  ...
  addreminderModel!.id!,
      ...
      "The dosage is ${addreminderModel.medcineDosge}",
      // tz.TZDateTime.now(tz.local).add(const Duration(seconds: 10)),
      scheduleTime,
      details,
      payload: "Don't forget to take your medicine",
